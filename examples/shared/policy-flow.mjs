import { V1_HARNESS_NODES } from "../../packages/harness/dist/index.js";
...
export function createPolicyFlowDefinition(intention) {
    ...
    const nodes = V1_HARNESS_NODES.map((entry, i) => ({ id: new entry.ctor().stage, type: entry.type, x: positions[i][0], y: positions[i][1] }));
    const edges = [
